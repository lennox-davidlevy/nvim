...
-- Colorscheme setup
local my_colorscheme = "tokyonight-night" -- options: "gruvbox-material", "gruvbox", "ayu", "bathory", "habamax", "taake", "yugen", "ashen", "tokyonight-night", "tokyonight-moon", "tokyonight-storm"
